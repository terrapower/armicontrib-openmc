...
class OpenMCWriter:
    ...
    def _writeAssemblyGeometry(self, assembly):
        ...
        if self.r.core.geomType == GeomType.HEX:
            ringInd = cartesianToRing(assembly.spatialLocator.getCompleteIndices()[0:2])
    ...
    def _writeBlockLatticeGeometry(
        ...
        if len(multGroups) == 2:
            blockLatticeCell, remainingComponents = self._writeBlockLatticeGeometry_2Groups(
                multGroups,
                block,
                blockHasDerivedShapeComponent,
                derivedShapeComponent,
    ...
    def _writeBlockLatticeGeometry_2Groups(
        self,
        multGroups,
        block,
        blockHasDerivedShapeComponent,
        ...
        if not isinstance(multGroupIndices, armi.reactor.grids.MultiIndexLocation):
            ...
            if self.r.core.geomType == GeomType.HEX:
                for location in multGroupIndices:
                    ...
                    blockLatticeIndices[ringInd[0]][ringInd[1]] = multGroupUniverse
